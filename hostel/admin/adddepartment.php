<?php
	...
	$conn->query("INSERT INTO `department` (department_name, department_sname, department_code) VALUES('$departmentname', '$departmentshortname', '$departmentcode')") or die(mysqli_error());
		
		

echo"<script>alert('Succssfully register'); ";
echo 'window.location.href = "adddepartment.php";';
echo "</script>";
	}
?>
<!DOCTYPE html>
