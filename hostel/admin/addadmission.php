<?php
	...
	$conn->query("INSERT INTO `admission` (description1) VALUES('$value')") or die(mysqli_error());
		
		

echo"<script>alert('Succssfully Added'); ";
echo 'window.location.href = "addadmission.php";';
echo "</script>";
	}
?>
<!DOCTYPE html>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Admission Details</div>
                    </div>
