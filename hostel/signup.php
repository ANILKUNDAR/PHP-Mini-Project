<?php
	...
	$conn->query("INSERT INTO `guest` (firstname, middlename, lastname, address, contactno,password) VALUES('$firstname', '$middlename', '$lastname', '$address', '$contactno','$password')") or die(mysqli_error());
...
<body>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h4 class="page-title" style="margin-top:20px"  >Student Registration </h4>
...
<div class="col-sm-8">
<input type="text" name="join" id="join"  class="form-control" required="required">
</div>
</div>
<div class="form-group">
