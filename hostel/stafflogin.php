...
$qu="SELECT * FROM staff WHERE staff_name='$mail' and password='$password'";
$query=mysqli_query($conn,$qu);
$num=mysqli_fetch_array($query);
if($num>0)
{

$_SESSION['name']=$_num['staff_name'];
$_SESSION['id']=$num['staff_id'];

echo '<script>window.location.href = "profile1.php";';
